  ...
  return (
    <div className='font-sans pt-8'>
      ...
      <div className='flex flex-col gap-2'>
        ...
        {list.map((item, index) => (
          <div className='grid grid-cols-[1fr_3fr_1fr] md:grid-cols-[1fr_3fr_1fr_1fr_1fr] items-center gap-4 py-4 px-4 border border-gray-100 hover:bg-gray-50 transition-colors text-sm' key={index}>
            <img className='w-12 h-16 object-cover border border-gray-200' src={item.image[0]} alt="" />
